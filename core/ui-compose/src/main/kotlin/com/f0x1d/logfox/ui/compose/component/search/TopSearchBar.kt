package com.f0x1d.logfox.ui.compose.component.search
...
fun TopSearchBar(
    ...
    Surface(modifier = modifier) {
        ...
        // Use the newer SearchBar API that takes an inputField parameter
        @Suppress("DEPRECATION") // Using suppressions until we can update to newer Material 3 version
        SearchBar(
            modifier = Modifier
                .fillMaxWidth()
                .padding(
